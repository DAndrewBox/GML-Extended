...
draw_text(8, 84, "Page " + string(page_index + 1) + ": " + script_get_name(page[page_index].callback) + "(" + page[page_index].args_str + ")");
draw_text(8, 8, "GML-Extended v" + GML_EXT_CURRENT_VERSION + " - GM v" + GM_CURRENT_VERSION.as_string + " Compatibility mode.")
draw_text(8, 32, "Press \"Q\" and \"E\" to navigate between pages.");
draw_text(8, 52, "Press \"Spacebar\" to preview ease animations.");
