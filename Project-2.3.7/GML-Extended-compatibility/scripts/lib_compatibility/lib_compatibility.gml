...
#macro	GM_VERSION_IS_2_3	__gml_ext_comp_is_gamemaker_major_version(2.3)
...
function __gml_ext_comp_init() {
	...
	if (GM_VERSION_IS_2_3 || GM_VERSION_IS_2022 || (GM_VERSION_IS_2023 && GM_CURRENT_VERSION.minor < 8)) {
...
function __gml_ext_comp_json_stringify(_json, _pretty = false, _filter_func = undefined) {
	static _use_compatibility = GM_VERSION_IS_2_3 || GM_VERSION_IS_2022 || (GM_VERSION_IS_2023 && GM_CURRENT_VERSION.minor < 2);
...
function __gml_ext_comp_string_ext(_str, _args = []) {
	static _use_compatibility = GM_VERSION_IS_2_3 || (GM_VERSION_IS_2022 && GM_CURRENT_VERSION.minor < 11);
...
function __gml_ext_comp_variable_clone(_value, _depth = 128) {
	static _use_compatibility = GM_VERSION_IS_2_3 || GM_VERSION_IS_2022 || (GM_VERSION_IS_2023 && GM_CURRENT_VERSION.minor < 4);
...
function __gml_ext_comp_array_contains(_array, _value, _offset = 0, _len = infinity) {
	static _use_compatibility = GM_VERSION_IS_2_3 || GM_VERSION_IS_2022;
